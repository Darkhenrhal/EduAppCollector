...
const Hero = () => {
    return (
        <section className="px-4 py-16 pt-10 lg:pt-8 md:pt-2 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
            <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5">
              <div className="max-w-xl mb-6">
                ...
                <span className="inline-block text-deep-purple-accent-400 text-purple"><span className="text-grey">with</span> MyGPA</span> 
                </h2>
                <p className="text-grey text-base md:text-lg">Calculate your GPA with ease using our free and open-source tool. Whether you're a high school or university student, this app helps you stay on top of your academic performance, free from distractions.</p>
              </div>
              <div className="flex items-center space-x-3">
                <button class="bg-grey hover:bg-black text-greylight font-bold py-2 px-4 rounded inline-flex items-center transform transition-transform duration-200 active:scale-95">
