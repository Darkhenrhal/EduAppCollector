    ...
    return(
        <section class="max-w-6xl mx-auto">
            ...
            <div class="grid mb-14 lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-12">
                ...
                <div>
                    <h3 class="text-gray-800 text-xl font-semibold mb-3">Ad-Free & Open Source</h3>
                    <p class="text-gray-600 text-sm">Enjoy a clean, distraction-free experience with no ads. Our open-source code ensures full transparency, with zero privacy or security concerns.</p>
                </div>
                </div>
                ...
                <div>
                    <h3 class="text-gray-800 text-xl font-semibold mb-3">Customizable Grading Methods</h3>
                    <p class="text-gray-600 text-sm">Adapt the calculator to your unique grading system. Whether you're in high school or university, easily configure it to suit your academic needs.</p>
                </div>
                </div>
                ...
                <div>
                    <h3 class="text-gray-800 text-xl font-semibold mb-3">Lightweight & Fast</h3>
                    <p class="text-gray-600 text-sm">With a small file size, the GPA calculator is quick to download and easy to run on any device, ensuring minimal storage usage.</p>
                </div>
                </div>
                ...
                <div>
                    <h3 class="text-gray-800 text-xl font-semibold mb-3">Inbuilt Database for Saving Your Data</h3>
                    <p class="text-gray-600 text-sm">Your GPA calculations are automatically saved with our inbuilt database, so you can track your academic progress over time without needing external storage.</p>
                </div>
                </div>
